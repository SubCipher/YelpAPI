...
static NSString * const kConsumerKey       = @"pqu7eieSKmJKmRcodh5B7w";
static NSString * const kConsumerSecret    = @"8XwCBK_6w4CwOpTw-jLu8IKVq1k";
static NSString * const kToken             = @"p7H1AGe4HG4GtoJHFhk3nm6dZtA2nqKD";
static NSString * const kTokenSecret       = @"BV0c6_xEQqUuEA0tWTHEr5En4pc";
